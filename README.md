...
# Notice 
BERT-finetuning code is located in branch `BERT-Classifier`, which has a separate README file on how to generate data and fine-tune the whole BERT-based classifier.
